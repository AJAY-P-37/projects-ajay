...
export interface TableActions<TData> {
  ...
  importColumnDetails?: Record<string, string>;
    ...
    <div className='flex justify-between m-3'>
      <div className='flex gap-2'>
        ...
        {actions.importRows && (
          <Popover
            content={
              <div className='space-y-3 max-w-80 overflow-auto'>
                <p>
...
export const TableActionsFooter = <TData extends BaseRow<TData>, TValue>({
  name,
  rows,
  tableSchema,
  actions,
